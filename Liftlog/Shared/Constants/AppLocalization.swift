...
enum AppLocalization {
    ...
    enum Common {
        ...
        static func add(count: Int) -> String {
            AppLocalization.Common.add + (count > 0 ? " (\(count))" : "")
        }
    }
    ...
    enum Workout {
        ...
        static let noWorkoutMessage = String(
            localized: "Create a new workout to get started."
        )
        static let title = String(localized: "Workouts")

        // MARK: - Add/Edit Workout
        static let name = String(localized: "Workout Name")
        ...
        static let emptyTitle = String(localized: "No Exercises yet")
    ...
    enum Progress {
        ...
        static let startLoggingToSeeProgress =
        String(localized: "Start logging sets or change the period to see your progress here.")
